...
var HomepageComponent = /** @class */ (function () {
    ...
    HomepageComponent.prototype.symSubmit = function (symbol, secname) {
        ...
        var fsym = this.filtsym(symbol);
        console.log("FILTSYM", fsym);
        console.log("FV", symbol);
        var observe = this.apiService.getSymbol(fsym);
    ...
    HomepageComponent.prototype.onSell = function (mystock) {
        ...
        var fsym = this.filtsym(mystock.symbol);
    ...
    HomepageComponent.prototype.filtsym = function (symbol) {
        var symlength = symbol.length;
        var fsym = '';
        console.log("length:", symlength);
        //filter "." in our symbol
        for (var y = 0; y < symlength; y++) {
            if (symbol[y] === ".") {
                null;
            }
            else {
...
/***/ "./src/app/symgraph/symgraph.component.css":
/*!*************************************************!*\
  !*** ./src/app/symgraph/symgraph.component.css ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/app/symgraph/symgraph.component.html":
/*!**************************************************!*\
  !*** ./src/app/symgraph/symgraph.component.html ***!
  \**************************************************/
/*! no static exports found */
...
/***/ "./src/app/symgraph/symgraph.component.ts":
/*!************************************************!*\
  !*** ./src/app/symgraph/symgraph.component.ts ***!
  \************************************************/
/*! exports provided: SymgraphComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SymgraphComponent", function() { return SymgraphComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _api_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../api.service */ "./src/app/api.service.ts");
...
var SymgraphComponent = /** @class */ (function () {
    function SymgraphComponent(apiService, route) {
        this.apiService = apiService;
        this.route = route;
        this.stockhist = [];
        this.currentsymbol = '';
    ...
    SymgraphComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.paramMap.subscribe(function (params) {
            ...
            obs.subscribe(function (response) {
                ...
                var o = _this.apiService.getuserSymgnl(symbol);
                o.subscribe(function (response) {
                    ...
                    _this.stockhist.forEach(function (day) {
                        ...
                        _this.stockdata.push(day.netgnl);
    ...
    SymgraphComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-symgraph',
            template: __webpack_require__(/*! ./symgraph.component.html */ "./src/app/symgraph/symgraph.component.html"),
            styles: [__webpack_require__(/*! ./symgraph.component.css */ "./src/app/symgraph/symgraph.component.css")]
        }),
        __metadata("design:paramtypes", [_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"],
