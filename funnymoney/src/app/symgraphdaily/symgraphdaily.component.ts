...
@Component({
  ...
  templateUrl: './symgraphdaily.component.html',
  styleUrls: ['./symgraphdaily.component.css']
})
export class SymgraphdailyComponent implements OnInit {
  stockhist = [];
  currentsymbol = '';
  chart = [];
  days = [];
    ...
    this.route.paramMap.subscribe( params => {
      ...
      //get daily net gains and losses for stock
       obs.subscribe( (response) => {this.stockbm = response
         ...
         let o = this.apiService.getsymDailies(symbol)
         ...
         this.stockhist.forEach( 
           ...
           this.stockdata.push(day.closeprice);
